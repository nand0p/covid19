def get_header():
  return '<html><link rel="icon" type="image/x-icon" href="favicon.ico" /><head><title>Covid-19 US Statistics</title>' + \
...
def get_footer():
  return '<center><p><br><p><b>Data Source:</b><br>COVID-19 Data Repository by the Center for Systems Science ' + \
